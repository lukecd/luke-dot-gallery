	...
	return (
		<div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#f5ead9] text-[#15274c] z-10">
			...
			<ul className="hidden md:flex">
				<li>
					<Link
						className="hover:bg-[#f36c3d] hover:border-[#f36c3d] border-2 px-4 py-2"
						to="top"
						smooth={true}
						duration={500}
					>
			...
			<ul
				className={
					!nav
						? "hidden"
						: "absolute top-0 left-0 w-full h-screen bg-[#f5ead9] text-[#15274c] flex flex-col justify-center items-center"
				}
			>
