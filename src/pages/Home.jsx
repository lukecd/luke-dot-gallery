  ...
  return (
    <div name='top' className='w-full h-screen bg-[#15274c] text-[#f5ead9]'>
        <div className='max-w-[1000px] mx-auto  flex flex-col justify-end h-full z-0'>
            <BouncingBalls />
            <img className="absolute top-20 right-10" style={{width: '600px'}} src={Logo} alt="logo" />
            <div className='absolute z-1 px-8'>
                ...
                <div>
                     <Link className='hover:bg-[#f36c3d] hover:border-[#f36c3d] border-2 px-4 py-3 my-8 flex items-center' to="contact" smooth={true} duration={500}>
