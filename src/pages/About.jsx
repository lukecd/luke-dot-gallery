            ...
            <div className='contentBody'>
                <div>
                    ...
                    <p className='my-5 px-2 leading-7'>
                        ...
                        a YouTuber. I've <a className="underline" href="https://www.amazon.com/s?k=luke+cassady-dorion&i=stripbooks&crid=287ICLAT11TVR&sprefix=luke+casssady-dorion%2Cstripbooks%2C284&ref=nb_sb_noss" rel="noreferrer" target="_blank">written and contributed</a> to multiple books on software development. I've taught yoga and I've taught Pilates.
                ...
                <div>
                    ...
                    <p className='my-5 px-2 leading-7'>
                       In the web1 era, I wrote Java applets and server-side processes. 
                       In the web2 era, I helped found a <a className="underline" href="https://youtube.com/picnicly" target="_blank">YouTube channel</a> dedicated to telling positive, uplifting stories.
                    </p>
