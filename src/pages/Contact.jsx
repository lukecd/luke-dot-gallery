...
const Contact = () => {
  return (
    <div name='contact' className='mt-20 w-full h-screen bg-[#15274c] text-[#f5ead9] flex justify-center items-center p-4'>
        <form action='https://getform.io/f/19f5b563-72f2-49a9-a5a0-faa9d50c4b5e' method='post' className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
               ...
               <p className='text-2xl my-5 px-4'>Working on something fun? Use the form, or email me Luke AT SPstories.com.</p>
               <p className='py-4'>
                <Social />
               </p>
            </div>
            ...
            <button className='hover:bg-[#f36c3d] hover:border-[#f36c3d] border-2 px-4 py-3 my-8 mx-auto flex items-center'>send</button>
        </form>
    </div>
  )
}
